...
public class MulticastAllAdapter extends BaseAdapter {
	private Context mContext;
	private Multicast mFragment;
	...
	public MulticastAllAdapter(Context context, ArrayList<String> datalist, GridView gridView, Multicast fragment) {
		mContext = context;
		mFragment = fragment;
		this.datalist = testAddProgram2(datalist);
	...
	public ArrayList<String> testAddProgram2(ArrayList<String> list){
		...
		LogUtils2.e("tempList== "+tempList.size());
		return tempList;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		LogUtils2.i("title== "+holder.title ); 
		holder.icon.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View v) {
//				Dialog dialog = NowplayerDialogUtils.createProgram2DetailDialog(mContext, catagoryData, loader, mFragment);
//				dialog.show();
				Toast.makeText(mContext, "lalala", 300).show();
